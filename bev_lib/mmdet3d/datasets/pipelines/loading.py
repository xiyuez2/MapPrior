...
class LoadBEVSegmentation:
    ...
    def __call__(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # print("debugging:",patch_box)
        
        # print("using map augmentation at line 291 of file mmdect/dataset/pipelines/loading")
        # a = -50
        # b = 50
        # aug_val_x = (b - a) * np.random.random_sample() + a
        # aug_val_y = (b - a) * np.random.random_sample() + a
        # patch_box = np.array(patch_box)
        # # print(patch_box[0],patch_box[1],np.shape(patch_box[0]),type(patch_box[0]))
        # patch_box[0] += aug_val_x
        # patch_box[1] += aug_val_y
        # patch_box = tuple(patch_box)
